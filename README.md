...
`sai_tui archive verify` walks it from the shell, `sai_tui archive
backup` keeps a second copy on another disk and `archive restore` puts
it back ([docs/archive/backup-and-restore.md](docs/archive/backup-and-restore.md), #15).
